    ...
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-checkbox v-model="isProject" label="科创项目申请" border size="small" @change = "getList"></el-checkbox>
          <el-checkbox v-model="isPaper" label="论文项目申请" border size="small" @change = "getList"></el-checkbox>
          <el-checkbox v-model="isChecking" label="审核中" border size="small" @change = "getList"></el-checkbox>
          <el-checkbox v-model="isPassed" label="审核通过" border size="small" @change = "getList"></el-checkbox>
          <el-checkbox v-model="isFailed" label="审核未通过" border size="small" @change = "getList"></el-checkbox>
        </el-form>
      </div>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getFormList(this.userId, this.listQuery.reviewerId, this.listQuery.pageNum, this.listQuery.pageSize,
        this.isProject, this.isPaper, this.isChecking, this.isPassed, this.isFailed).then(res => {
